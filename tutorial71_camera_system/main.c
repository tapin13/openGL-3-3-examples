...
void processInput(GLFWwindow *window, GLfloat *cameraPosition, GLfloat *cameraFront, GLfloat *cameraUp);
...
int main(int argc, char** argv) {
    ...
    while(glfwWindowShouldClose(window) == 0) {
        ...
        processInput(window, cameraPosition, cameraFront, cameraUp);
