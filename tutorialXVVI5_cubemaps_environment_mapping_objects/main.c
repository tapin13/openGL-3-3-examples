...
int main(int argc, char** argv) {
    ...
    model *cylinderModel = modelLoad("models/cylinder/cylinder.obj");
    model *skullModel = modelLoad("models/skull/skull.obj");
    model *sphereModel = modelLoad("models/sphere/sphere.obj");
    model *nanosuitModel = modelLoad("models/nanosuit/nanosuit.obj");
    model *handgunModel = modelLoad("models/handgun/handgun.obj");
    model *skull3Model = modelLoad("models/skull_v3/12140_Skull_v3_L2.obj");
    ...
    while(glfwWindowShouldClose(window) == 0) {
        ...
        drawModel(modelShaderId, nanosuitModel);
