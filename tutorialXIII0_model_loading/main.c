...
int main(int argc, char** argv) {
    ...
    */
    ...
    float clearColor[] = { 0.5, 0.5, 0.5, 1.0f }; // default
...
//        }
        ...
        matrix_identity((GLfloat *)modelMatrix);
        matrix_translate((GLfloat *)modelMatrix, (GLfloat *)&modelPositions);
        //float angel = 100.0f * glfwGetTime();
        //matrix_rotate((GLfloat *)modelMatrix, angel, axis);
        glUniformMatrix4fv(modelID, 1, GL_TRUE, (const float *)modelMatrix);

        model_draw(&nanosuit, programId);
