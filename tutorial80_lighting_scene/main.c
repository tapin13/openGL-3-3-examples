...
int main(int argc, char** argv) {
    ...
    lightProgramId = loadShader("shader.vs", "shader_light.fs");
    if(lightProgramId == -1) {
        return (EXIT_FAILURE);
    }
    ...
    glVertexAttribPointer(
        ...
        sizeof(GLfloat) * 3, // stride - space between consecutive vertex attributes
    ...
    GLfloat lightPosition[3] = { 1.2f, 1.0f, 2.0f };
    ...
    while(glfwWindowShouldClose(window) == 0) {
        ...
        //matrix_scale((GLfloat *)modelMatrix, (GLfloat *)lightPosition);
