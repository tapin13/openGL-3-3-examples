...
int main(int argc, char** argv) {
    ...
    //float cubeMaterial_ambient[3] = { 0.0f, 0.1f, 0.06f };
    //float cubeMaterial_diffuse[3] = { 0.0f, 0.50980392f, 0.50980392f };
    //float cubeMaterial_specular[3] = { 0.50196078f, 0.50196078f, 0.50196078f };
...
//        lightAmbient[0] = sin(glfwGetTime());
//        lightAmbient[1] = sin(glfwGetTime() * 2);
//        lightAmbient[2] = sin(glfwGetTime() * 3);
//        printf("lightAmbient: %f, %f, %f\n", lightAmbient[0], lightAmbient[1], lightAmbient[2]);
//        glUniform3fv(lightAmbientID, 1, &lightAmbient[0]);

        lightDiffuse[0] = sin(glfwGetTime());
        lightDiffuse[1] = sin(glfwGetTime() * 2);
        lightDiffuse[2] = sin(glfwGetTime() * 3);
        printf("lightDiffuse: %f, %f, %f\n", lightDiffuse[0], lightDiffuse[1], lightDiffuse[2]);
        glUniform3fv(lightDiffuseID, 1, &lightDiffuse[0]);
        
//        lightSpecular[0] = sin(glfwGetTime());
//        lightSpecular[1] = sin(glfwGetTime() * 2);
//        lightSpecular[2] = sin(glfwGetTime() * 3);
//        printf("lightSpecular: %f, %f, %f\n", lightSpecular[0], lightSpecular[1], lightSpecular[2]);
//        glUniform3fv(lightSpecularID, 1, &lightSpecular[0]);
